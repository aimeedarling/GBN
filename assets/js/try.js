$(function () {
    //names function so we can call it later
    function handleNewsSearch(userSearch) {
            ...
            $.ajax({
                ...
                success: function (news) {
                    ...
                    for (var i in latestNews) {
                        var api_key = "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";
    ...
    $("#searchbtn").on("click", function (e) {
        ...
        //clears user search bar value
        $('#user-input').val('')
        handleNewsSearch(userSearch)
